...
CONF_DEVICE = "device"
CONF_TEMPERATURE_SENSOR = "temperature_sensor"  # Legacy single selection
CONF_HUMIDITY_SENSOR = "humidity_sensor"  # Legacy single selection
...
CONF_ACTUAL_ENERGY_SENSOR = "actual_energy_sensor"
...
CONF_PRESET_SMART = "smart_enabled"
CONF_PRESET_MODE = "smart_mode"
CONF_PRESET_ALLOWED_MODES = "allowed_modes"
CONF_PRESET_DEADBAND = "deadband"
...
PRESET_WORK_CURVE_GENTLE = "gentle"
PRESET_WORK_CURVE_BALANCED = "balanced"
PRESET_WORK_CURVE_RAPID = "rapid"
...
SMART_MODE_DRY = "dry"
SMART_MODES = (SMART_MODE_AUTO, SMART_MODE_COOL, SMART_MODE_HEAT, SMART_MODE_DRY)
DEFAULT_SMART_DEADBAND = 0.5
SMART_COMMAND_COOLDOWN_SECONDS = 180
...
DEVICE_SENSORS = {
    ...
    "TemSen": {
        "name": "Additional Temperature Sensor",
...
STORAGE_KEY_INSTALLATIONS = f"{DOMAIN}.installations"
